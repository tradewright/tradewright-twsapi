...
#End Region
    ...
    Public Sub init(execFilter As ExecutionFilter)
        ...
        With execFilter
            ...
            txtAcctCode.Text = .AccountCode
            txtTime.Text = .Time
            txtSymbol.Text = .Symbol
            txtSecType.Text = SecurityTypes.ToExternalString(.SecType)
            txtExchange.Text = .Exchange
            txtAction.Text = OrderActions.ToInternalString(.Action)
    ...
    Private Sub cmdOK_Click(sender As Object, e As EventArgs) Handles cmdOk.Click
        ...
        With m_execFilter
            ...
            .AccountCode = txtAcctCode.Text
            .Time = txtTime.Text
            .Symbol = txtSymbol.Text
            .SecType = SecurityTypes.Parse(txtSecType.Text)
            .Exchange = txtExchange.Text
            .Action = OrderActions.Parse(txtAction.Text)
