...
Class dlgSmartComboRoutingParams
    ...
    Private m_smartComboRoutingParams As List(Of TagValue)
    ...
    Public ReadOnly Property smartComboRoutingParams() As List(Of TagValue)
        Get
    ...
    ' Public Methods
    ' ===============================================================================
    Public Sub init(smartComboRoutingParams As List(Of TagValue), dlgTitle As String)
    ...
    Private Sub OK_Button_Click(sender As System.Object, e As System.EventArgs) Handles OK_Button.Click
        m_smartComboRoutingParams = New List(Of TagValue)
        ...
        If (grdParams.Items.Count > 0) Then
            ...
            For Each item As ListViewItem In grdParams.Items
                ...
                m_smartComboRoutingParams.Add(New TagValue() With {.Tag = tag, .Value = value})
            Next
