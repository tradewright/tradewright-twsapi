...
#Region "Upgrade Support "
    ...
    End Property
#End Region
    Private m_subscription As ScannerSubscription
    Private m_mainWnd As MainForm

    Private m_id As Integer
    Private m_ok As Boolean
    Private m_scannerSubscriptionOptions As List(Of TagValue)
    ...
    Public Sub init(mainWin As System.Windows.Forms.Form)
        m_ok = False
        m_mainWnd = mainWin
        m_subscription = New ScannerSubscription
    End Sub
    ...
    Private Sub cmdRequestParameters_Click(sender As Object, e As EventArgs) Handles cmdRequestParameters.Click
        m_mainWnd.Api.RequestScannerParameters()
        Hide()
    End Sub
    ...
    Private Sub cmdSubscribe_Click(sender As Object, e As EventArgs) Handles cmdSubscribe.Click
        populateSubscription()
        m_mainWnd.Api.RequestScannerSubscription(m_id, m_subscription)      ', m_scannerSubscriptionOptions)
        Hide()
    End Sub
    ...
    Private Sub cmdOptions_Click(sender As System.Object, e As System.EventArgs) Handles cmdOptions.Click
        ...
        If res = DialogResult.OK Then
            m_scannerSubscriptionOptions = New List(Of TagValue)(dlg.smartComboRoutingParams)
        End If
    End Sub
    ...
    Private Sub populateSubscription()
        ...
        With m_subscription
            .NumberOfRows = NullableIntegerFromString(txtNumberOfRows.Text)
            .Instrument = txtInstrument.Text
            .LocationCode = txtLocationCode.Text
            .ScanCode = txtScanCode.Text
            .AbovePrice = NullableDoubleFromString(txtAbovePrice.Text)
            .BelowPrice = NullableDoubleFromString(txtBelowPrice.Text)
            .AboveVolume = NullableIntegerFromString(txtAboveVolume.Text)
            .AverageOptionVolumeAbove = NullableIntegerFromString(txtAverageOptionVolumeAbove.Text)
            .MarketCapAbove = NullableDoubleFromString(TxtMarketCapAbove.Text)
            .MarketCapBelow = NullableDoubleFromString(txtMarketCapBelow.Text)
            ...
            .CouponRateAbove = NullableDoubleFromString(txtCouponRateAbove.Text)
            .CouponRateBelow = NullableDoubleFromString(txtCouponRateBelow.Text)
            .ExcludeConvertible = txtExcludeConvertibles.Text
