...
#End Region
    ...
    ' Button Events
    '================================================================================
    Private Sub btnClose_Click(sender As Object, eventArgs As EventArgs) Handles CloseButton.Click
        mOk = False
        Me.Close()
    End Sub
    ...
    '--------------------------------------------------------------------------------
    Public Sub UpdateMktDepth(tickerId As Integer, rowId As Integer, marketMaker As String, operation As DOMOperation, side As DOMSide, price As Double, size As Integer)
    ...
    Private Function getContractString(contract As Contract) As String
