...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtExpiry.Size = New System.Drawing.Size(88, 13)
...
#End Region
    ...
    Private m_options As List(Of TagValue)
    ...
    Private Sub cmdAddCmboLegs_Click(sender As Object, e As EventArgs) Handles cmdAddCmboLegs.Click
        ...
        If dlgComboLegs.ok Then
            ...
            m_orderInfo.OrderComboLegs = dlgComboLegs.orderComboLegs.ToArray
    ...
    Private Sub cmdOK_Click(sender As Object, e As EventArgs) Handles cmdOk.Click
        ...
        m_contractInfo.SecType = SecurityTypes.Parse(txtSecType.Text)
        m_contractInfo.Expiry = txtExpiry.Text
        m_contractInfo.Strike = CDbl(txtStrike.Text)
        m_contractInfo.OptRight = OptionRights.Parse(txtRight.Text)
        m_contractInfo.Multiplier = If(TextMultiplier.Text = "", 1, CInt(TextMultiplier.Text))
        m_contractInfo.Exchange = txtExchange.Text
        m_contractInfo.PrimaryExch = TxtPrimaryExchange.Text
        m_contractInfo.CurrencyCode = txtCurrency.Text
        ...
        m_orderInfo.Action = OrderActions.Parse(txtAction.Text)
        m_orderInfo.TotalQuantity = CDbl(txtQuantity.Text)
        m_orderInfo.OrderType = OrderTypes.Parse(txtOrderType.Text)
    ...
    '--------------------------------------------------------------------------------
    Public Sub init(dlgType As DialogType, contractInfo As Contract,
        orderInfo As Order, underComp As UnderComp,
        options As List(Of TagValue),
    ...
    Private Sub Initialize()
        ...
        txtEndDateTime.Text = Format(Now(), "yyyy-MM-dd HH:mm:ss")
    ...
    Private Sub cmdOptions_Click(sender As System.Object, e As System.EventArgs) Handles cmdOptions.Click
        ...
        Dim res = dlg.ShowDialog()
        If res = DialogResult.OK Then
            m_options = New List(Of TagValue)(dlg.smartComboRoutingParams)
        End If
