...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtLastUpdateTime.BorderStyle = System.Windows.Forms.BorderStyle.None
        ...
        Me.txtLastUpdateTime.Size = New System.Drawing.Size(89, 13)
        ...
        Me.lstPortfolioData.BorderStyle = System.Windows.Forms.BorderStyle.None
        ...
        Me.lstPortfolioData.Size = New System.Drawing.Size(633, 84)
        ...
        Me.lstKeyValueData.BorderStyle = System.Windows.Forms.BorderStyle.None
        ...
        Me.lstKeyValueData.Size = New System.Drawing.Size(633, 112)
...
#End Region
    ...
    Public Sub updateAccountValue(key As String, value As String, currency As String, accountName As String)
        Dim msg = "key=" & key & " value=" & value & " currency=" & currency & " account=" & accountName
        m_utils.addListItem(Utils.ListType.AccountData, msg)
    End Sub

    '--------------------------------------------------------------------------------
    ' Updates a portfolio position details
    '--------------------------------------------------------------------------------
    Public Sub updatePortfolio(contract As Contract, position As Integer, marketPrice As Double, marketValue As Double, averageCost As Double, unrealizedPNL As Double, realizedPNL As Double, accountName As String)
        Dim msg As String

        With contract
            msg = "conId=" & .ConId & " symbol=" & .Symbol & " secType=" & .SecType & " lastTradeDate=" & .Expiry & " strike=" & .Strike _
            & " right=" & .OptRight & " multiplier=" & .Multiplier & " primaryExch=" & .PrimaryExch & " currency=" & .CurrencyCode _
